...
export default function ProductListingCart({category, imagePath, price,ownerName, ownerPhone}:iAppProps) {
  ...
  return (
    <div className="flex flex-col">
     <div className="relative h-72">
        <Image src={`${imagePath}`} alt="Image of Product"
        fill
        className="rounded-lg h-full object-cover"
        />
     </div>
     <Link href="/hello" className="mt-2 grid grid-cols-2">
